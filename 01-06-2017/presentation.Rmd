...
R é uma linguagem versátil com foco em análise e estátisica de dados. Existe uma comunidade crescente e segundo o TIOBE <http://www.tiobe.com/tiobe-index> R ocupa a decima quarta posição no ranking de linguagens mais utilizadas (Maio de 2017).
...
R possui uma syntax ligeiramente similar a linguagens mais comumente usadas domo C e Python.
